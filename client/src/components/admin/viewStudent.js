                ...
                <div className="results">
                    ...
                    <div class="graph-tbl">
                        ...
                        <table>
                            ...
                            <col width="10%" />
                            <col width="45%" />
                            <tr><td><ViewResult num='1' survType='senior' ref={this.graph1} /></td><td></td><td><ViewResult num='2' survType='senior' ref={this.graph2} /></td></tr>
                            <tr><td><ViewResult num='3' survType='senior' ref={this.graph3} /></td><td></td><td><ViewResult num='4' survType='senior' ref={this.graph4} /></td></tr>
                            <tr><td><ViewResult num='5' survType='senior' ref={this.graph5} /></td><td></td><td><ViewResult num='6' survType='senior' ref={this.graph6} /></td></tr>
                            <tr><td><ViewResult num='7' survType='senior' ref={this.graph7} /></td><td></td><td><ViewResult num='8' survType='senior' ref={this.graph8} /></td></tr>
                            <tr><td><ViewResult num='9' survType='senior' ref={this.graph9} /></td><td></td><td><ViewResult num='10' survType='senior' ref={this.graph10} /></td></tr>
                            <tr><td><ViewResult num='11' survType='senior' ref={this.graph11} /></td><td></td><td><ViewResult num='12' survType='senior' ref={this.graph12} /></td></tr>
                            <tr><td><ViewResult num='13' survType='senior' ref={this.graph13} /></td><td></td><td><ViewResult num='14' survType='senior' ref={this.graph14} /></td></tr>
                        </table>
                    </div>
                    <div class="comments">
